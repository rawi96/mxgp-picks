...
const RiderForm: FC<Props> = ({ addRider, editRider, prefilledRider, isLoading }) => {
  ...
  return (
    <div className="flex min-h-full flex-col py-8 px-8">
      <h2 className="text-3xl font-bold tracking-tight text-red-700">Rider</h2>
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <form className="space-y-6" onSubmit={handleSubmit(onSubmit)}>
          ...
          <div>
            <label htmlFor="lastname" className="block text-sm font-medium text-red-700">
              Lastname
            </label>
            <div className="mt-1">
              <input
          ...
          <div>
            <label htmlFor="numberplate" className="block text-sm font-medium text-red-700">
              Numberplate
            </label>
            <div className="mt-1">
              <input
